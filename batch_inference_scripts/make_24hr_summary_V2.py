...
if __name__ == '__main__':
    #base_path = '/media/data_cifs/projects/prj_nih/prj_andrew_holmes/inference/FallonTDP43Analysis/TDP43_I3DEmbeddings/model_predictions' 
    base_path = '/cifs/data/tserre/CLPS_Serre_Lab/projects/prj_nih/prj_andrew_holmes/inference/FallonTDP43Analysis/TDP43_I3DEmbeddings/model_predictions'
    datasets = os.listdir(base_path)

    pred_datafiles = getFiles(base_path)
    all_folders = glob.glob(os.path.join(base_path,'*'))

    df = pd.read_csv('fallon_q331k_metadata.csv')
    csvfile = open('AllFallonTDP43Dec2021.csv', 'w+')
